...
```{r}
'PreSch Density' <- mpsz3414$'PreSch Count'/ mpsz3414$Area * 1000000
```
...
ggplot(data = mpsz3414, 
       aes(x= as.numeric(mpsz3414$'PreSch Density')))+ 
...
```{r}
ggplot(mpsz3414, aes(x = as.numeric(mpsz3414$'PreSch Density'), y = as.numeric(mpsz3414$'PreSch Count'))) + geom_point()
```
